    ...
    <div class="container" style="padding-bottom: 3%;">
      <div class="row">
        <div class="col" style="height: fit-content;" >
          ...
          <hr>
          <form name="form1" method="post" action="V_Demand2.jsp" style="font-size: large;margin-top: 3ch;">
		  <input type="hidden" name="m_id" id="m_id" value="<%=rs5.getString(1)%>">
              <div class="form-group row">
               <label for="Name" class="col-4 col-form-label" style="text-align: center;"> <b>服務單位</b></label>
                <div class="col-8" style="padding-right: 5ch;">
                  <input type="text" name="unit_name" class="form-control" id="Name" value="時間銀行" readonly>
                </div>
              </div>
              <div class="form-group row">
                <label for="phone" class="col-4 col-form-label" style="text-align: center;"><b>連絡電話</b></label>
                <div class="col-8" style="padding-right: 5ch;">
                  <input type="text"  name="phone" class="form-control" id="phone" value="<%=rs5.getString(4)%>">
                </div>
            </div>
              <div class="form-group row">
                  <label for="servicename" class="col-4 col-form-label" style="text-align: center;"><b>服務名稱</b></label>
                  <div class="col-8" style="padding-right: 5ch;">
                    <input type="text" name="service_name" class="form-control" id="servicename" value="">
                  </div>
              </div>

              <div class="form-group row">
                  <label for="class"  name="service_class" class="col-4 col-form-label" style="text-align: center;"><b>服務類別</b></label>
              </div>
              <div class="form-group row">
                <div class="col">
            ...
            <div class="col" style="padding-left: 70%;padding-top: 5ch;">
                  <a href="../page/timebank.jsp"><button class="btn btn-warning" type="button" style="color: white;" >取消</button></a>
                   <button class="btn btn-success" type="submit" style="color: white;">下一步</button> 
              </div>
			  </form>
          </div>
        <div class="col" style="height: fit-content;">
          <img src="../image/V_form.png" class="img-fluid rounded" alt="Responsive image">            
        </div>
      </div>
    </div>
