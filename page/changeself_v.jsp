      ...
      <div class="col-md-6 card shadow text-center mx-auto">
          <form class="card-body row g-3">
            ...
            <h6 class="card-subtitle m-auto fw-lighter" style="color: red;">請確認米字號(*)欄位都已填寫</h6>
                    <input type="text" readonly class="form-control-plaintext" style="text-align: center;font-size:20px" name="id" value="<%=rs.getString(10)%>">
                    <input type="text" readonly class="form-control-plaintext" style="text-align: center;font-size:20px" value="<%=rs.getString(11)%>">
               ...
               <div class="form-floating col-md-12">
                ...
                <div class="form-floating col-md-12">
                    <input type="name" class="form-control" id="name" name="tel" placeholder="name@example.com">
                ...
                <a class="btn btn-outline-primary" href="../page/volunteerself.jsp">取消</a>
          </form>
        ...
        <div class="col-md-5 card shadow text-center mx-auto">
          ...
          <img style="width:auto;height: 40%;" src="../image/ppp0.jpeg" class="img-fluid">
