...
//Step 5: 顯示結果      
				...
				String n_ull="null";
				String getV="";
				String sql="SELECT  ROW_NUMBER()  OVER (ORDER BY`unit_name`) AS apply_num,`unit_name`,`service_name`,`service_class`,`service_sdate`,`service_edate`,`service_date`,`Rejection`,`sing_up_status`FROM `sing_up`";
				ResultSet tmp =  con.createStatement().executeQuery(sql);
%>
      <div style="padding-top: 15ch;"></div>
      <div class="container" style="font-size: 3ch;font-family: 'Times New Roman', Times, serif;padding-bottom: 2ch;"><b>近期報名紀錄</b></div>
...
%>				
                    <tr>               
                        ...
                        <td id="status<%=a%>"><%=tmp.getString(9)%></td>
