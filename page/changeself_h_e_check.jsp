...
<div style="margin-top: 70px;">
	...
	<%
							...
							sql = "UPDATE `member` SET `chinese_name`='"+ name +"' WHERE `unit_name`='"+ com +"'";
							con.createStatement().execute(sql);
							sql = "UPDATE `member` SET `phone`='"+ tel +"' WHERE `unit_name`='"+ com +"'";
							con.createStatement().execute(sql);
							sql = "UPDATE `member` SET `email`='"+ email +"' WHERE `unit_name`='"+ com +"'";
							con.createStatement().execute(sql);
							con.close();
							response.sendRedirect("changeself_h_e_end.jsp") ;
						}
						con.close();
					}
			}
