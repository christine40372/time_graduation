    ...
    <div class="container" style="padding-bottom: 3%;">
      <div class="row">
        <div class="col" style="height: fit-content;" >
          ...
          <hr>
		  <form name="form1"  action="V_Demand3.jsp" method="post" style="font-size: large;margin-top: 3ch;">
           ...
           <input type="hidden" name="serviceclass" value="<%=serviceclass%>">
              ...
              <div class="form-group row">
                ...
                <div class="row">
                  ...
                  <div class="col-md-auto">
                    <input type="text" name="people_number" class="form-control" placeholder="請輸入" id="numbere" style="font-size: small;width: 100px;margin-left: -5.5ch;">
                   </div>
                </div>
               </div>
            <!--加一行鍵-->
            ...
            <div class="col-15" style="padding-left: 70%;padding-top: 5ch;">
                  <a href="../page/V_Demand.jsp"><button class="btn btn-warning" type="button" style="color: white;" >上一步</button></a>
