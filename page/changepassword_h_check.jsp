...
<div style="margin-top: 70px;">
		...
		try {
				...
				//Step 2: 建立連線 	
					...
					if(con.isClosed())
						...
						if(pwd_old.equals("") || pwd_new.equals("") || pwd_again.equals("")){
	%>
							<center>
								<h3>請完整填寫欄位</h3>
								<a href="changepassword_h.jsp" style="font-size: 20px">重新填寫</a>
							</center>
	<%
						}
						else if(pwd_new.equals(pwd_again)){
							sql = "SELECT * FROM `member` WHERE `m_password`='"+ pwd_old +"';";
	...
	%>
								<center>
									<h3>現在密碼錯誤，請重新輸入</h3>
									<a href="changepassword_h.jsp" style="font-size: 20px">修改密碼</a>
								</center>
	<%
							}
						}
