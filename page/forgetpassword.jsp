...
<main class="container" style="padding-top:60px;">
    ...
    <h6 class="card-subtitle m-auto fw-lighter">請輸入您的帳號及信箱以查詢密碼</h6>
	<h6 style="color: red;">*若您忘記註冊時帳號及信箱，請聯絡管理員。</h6>
    <form class="card-body row g-3 mx-auto" action="forgetpassword_check.jsp" method="post">
		<input type="account" class="form-control" id="account" name="acc" placeholder="your account">
        <input type="email" class="form-control" id="email" name="email" placeholder="name@example.com">
        <input class="w-100 btn btn-lg " style="background:#42b72a ;color:white" type="submit" value="下一步">
</form>
</div>
</div>
</main>
