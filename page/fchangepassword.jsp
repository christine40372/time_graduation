...
<main class="container" style="padding-top:60px;">
    ...
    <input type="text" readonly class="form-control-plaintext" style="text-align: center;font-size:20px" name="email" value="<%=rs.getString(5)%>">
    <form class="card-body row g-3 mx-auto" action="fchangepassword_check.jsp" method="post">
        ...
        <div class="form-floating col-md-12">
            ...
            <input class="w-100 btn btn-lg " style="background:#42b72a ;color:white" type="submit" value="儲存">
                        ...
                        <a class="btn btn-outline-primary" href="../page/hoursignin.jsp">取消</a>
    </form>
