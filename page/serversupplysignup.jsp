  ...
  <main class="container" style="padding-top:60px;">
    <div class="row g-3">
      <div class="col-md-6 card shadow text-center mx-auto">
          <form class="card-body row g-3" action="serversupplysignup_check.jsp" method="post">
            <h1 class="card-title m-auto fw-lighter">服務提供者</h1>
            ...
            <form class="card-body row g-3 mx-auto">
               ...
               <div class="form-floating col-md-12">
                ...
                <a class="btn btn-outline-primary" href="../page/serversupplysignin.jsp">已經有帳號了?按此登入</a>
            </form>
          </form>
        </div>
