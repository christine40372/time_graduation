...
//Step 4: 執行 SQL 指令	
           sql="INSERT into `service` (`unit_name`,`phone`, `service_name`, `service_class`,`service_sdate`, `service_edate`, `service_date`, `service_time1`, `service_time2`, `people_number`, `service_content`, `address`, `volunteers_condition`,`member_ID`)VALUES("+"'"+new_name+"'"+","+"'"+phone+"'"+","+"'"+service_name+"'"+","+"'"+serviceclass+"'"+","+"'"+service_sdate+"'"+","+"'"+service_edate+"'"+","+"'"+service_date+"'"+","+"'"+service_time1+"'"+","+"'"+service_time2+"'"+","+"'"+people_number+"'"+","+"'"+service_content+"'"+","+"'"+address+"'"+","+"'"+volunteers_condition+"'"+","+"'"+m_id+"'"+")";
           con.createStatement().execute(sql);
//Step 6: 關閉連線
           con.close();
//Step 5: 顯示結果 
          //直接顯示最新的資料
           response.sendRedirect("../page/timebank.jsp");
       }
    }
