...
//Step 4: 執行 SQL 指令
			...
			if (session.getAttribute("acc")!=null && session.getAttribute("status")=="時數認證者"){
				response.sendRedirect("hourself_e.jsp");
			}
			else {
    ...
    <main class="container my-auto" style="padding-top: 60px;">
        <div class="row g-3">
            ...
            <div class="col-md-6 card shadow text-center mx-auto">
                <form class="card-body row g-3" action="hoursignin_check.jsp" method="post">
                    <h1 class="card-title fw-lighter">歡迎您來到<br>志工時區X時間銀行</h1>
                    <h6 class="h6 fw-normal">時數認證者登入</h6>
                    <ul class="nav navbar-nav navbar-right">
                        <li class="nav-item">
                            <a class="btn btn-light" href="../page/hoursignup.jsp">還沒有帳號嗎?</a></li>
                        <li class="nav-item">
                            <a class="btn btn-outline-dark" href="../page/hoursignup.jsp"><i class="fa-solid fa-user-plus"></i>
                               註冊</a></li>
                    </ul>
                    <div class="form-floating">
                      <input class="form-control" id="account" name="acc">
