    ...
    <div class="container" style="padding-bottom: 3%;">
      <div class="row">
        <div class="col" style="height: fit-content;" >
          ...
          <hr>
           <form  action="V_Demand3_add.jsp" method="get" style="font-size: large;">
		   <input type="hidden" name="m_id" value="<%=m_id%>">
            <div class="form-group row">
               ...
               <div class="form-group row">
                <label for="Name" class="col-md-auto col-form-label" style="text-align: center;"><b>連絡電話</b></label>
                <div class="col-8" style="padding-right: 5ch;">
                  <input type="text"  name="phone" class="form-control" readonly id="phone" value="<%=phone%>">
                </div>
            </div>
               <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="row">
               <div class="col" >
                 <input type="text" class="form-control" name="service_content" readonly id="content" value="<%=service_content%>"></input>
              </div>
              </div>
             </div>
             ...
             <div class="form-group row">
              ...
              <div class="row">
               <div class="col">
                 <input type="text" class="form-control" name="volunteers_condition" readonly id="condition"  value="<%=volunteers_condition%>">
            ...
            <script>
              ...
              <div class="col-15" style="padding-left: 70%;padding-top: 5ch;">
                    <a href="../page/V_Demand2.jsp"><button class="btn btn-warning" type="button" style="color: white;">上一步</button></a>
                    <a href="../page/timebank.jsp"><button class="btn btn-success" type="submit" style="color: white;" onclick="myalert()" >送出</button></a>
                </div>
				 </form>
            </div>
          <div class="col" style="height: fit-content;">
            <img src="../image/V_form2.png" class="img-fluid rounded" alt="Responsive image">            
          </div>
        </div>
      </div>
