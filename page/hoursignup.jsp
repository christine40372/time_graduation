    ...
    <main class="container my-auto" style="padding-top: 60px;">
        <div class="row g-3">
            <div class="col-md-6 card shadow text-center mx-auto">
                <form class="card-body row g-3" action="hoursignup_check.jsp" method="post">
                    <h1 class="card-title m-auto fw-lighter">時數認證者</h1>
                <h6 class="card-subtitle m-auto fw-lighter">註冊</h6>
                <form class="card-body row g-3 mx-auto">
                    <div class="form-floating col-md-12">
                        <input type="name" class="form-control" id="name" name="com" placeholder="name">
                        <label for="name">單位名稱</label></div>
                    <div class="form-floating col-md-12">
                   ...
                   <div class="form-floating col-md-12">
                    ...
                    <div class="form-floating row g-3 mx-auto">
                      <h6 style="color: red;">*需先確認身分資料後，帳號才會開通，管理員會在1至3天內致電與您確認，敬請留意來電。</h6>
                    ...
                    <a class="btn btn-outline-primary" href="../page/hoursignin.jsp">已經有帳號了?按此登入</a>
                </form>
                </form>
            </div>
            <div class="col-md-6 display-5 fw-normal d-flex">
                <img style="width: 100%;height: auto;" src="../image/hoursign.png" ></div>
