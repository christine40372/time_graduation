...
<body>
   ...
   <script> 
    function myFunc() { 
        ...
        if (r == true) { 
          alert("已送出")
          location.href='S_time-apply.jsp';
        } 
        else { 
...
%>
    <div style="background-color: #f4f8f9;;margin-top: 70px;">
        <div class="container" style="padding-top: 5ch;" >
            <h4  align="center" valign="center"><b>拒絕受理</b></h4>
            <br>
        <form action="S_Refuse_add.jsp" method="POST">    
            <table align="center" cellpadding="50">
              <td class="td1">
                 <p align="center"><b>請輸入拒絕原因</b></p>
					<input type="hidden" name="getvalue" value="<%=getvalue%>">
                    <input type="radio" name="reason" value="學生時數填寫錯誤">學生時數填寫錯誤 
                    &nbsp;&nbsp; 說明：<input type="text" name="Description1" size="30">
                    <br>
                    <br>
                    <input type="radio" name="reason" value="學生時段填寫錯誤">學生時段填寫錯誤
                    &nbsp;&nbsp; 說明：<input type="text" name="Description2" size="30">
                    <br>
                    <br>
                    <input type="radio" name="reason" value="其它：(請輸入)">其它：(請輸入)
                  ...
                  <view  class="btn2">
                    ...
                    <view class="btn2">
                    <input type="button" value="上一步" id="rightButton" onclick="location.href='S_time-apply.jsp'">
                    &nbsp;&nbsp;
                    </view>
