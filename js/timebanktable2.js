...
$(function () {
    /*----產生data-th-----*/
    let $table2 = $("#myTable2");
    let $thRows2 = $table2.find("thead th");
    $thRows2.each(function (key, thRow2) {
      $table2
        .find("tbody tr td:nth-child(" + (key + 1) + ")")
        .attr("data-th", $(thRow2).text());
    });
    /*-----------*/
    goPage2(1, 10); // 一開始先秀第一頁,以及每一頁最多兩筆資料
  });
  
  
  function goPage2(currentPage, pageSize) {
    
      var tr = $("#myTable2 tbody tr");
      var num = $("#myTable2 tbody tr").length; //表格所有行數(所有記錄數)
      ...
      var tempStr = "";
      if (currentPage > 1) {
          tempStr += `<li class="page-item"><a class="page-link" href="javascript:;" onClick="goPage2(1,${pageSize})">首頁</a></li>`;
          tempStr += `<li class="page-item"><a class="page-link" href="javascript:;" onClick="goPage2(${currentPage - 1},${pageSize})">&#171</a></li>`;
      ...
      if (currentPage < totalPage) {
          tempStr += `<li class="page-item"><a class="page-link" href="javascript:;" onClick="goPage2(${currentPage + 1},${pageSize})">&#187</a></li>`;
          tempStr += `<li class="page-item"><a class="page-link" href="javascript:;" onClick="goPage2(${totalPage},${pageSize})">尾頁</a></li>`;
      } else {
